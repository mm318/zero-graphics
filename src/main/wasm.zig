...
export fn app_init() u32 {
    ...
    gpa = .{ .backing_allocator = global_arena.allocator() };
...
const WebGL = struct {
    ...
    pub extern "webgl" fn blendEquation(_mode: GLenum) callconv(.C) void;

    pub extern "webgl" fn getStringJs(name: GLenum) void;
    pub fn getString(name: GLenum) callconv(.C) ?[*:0]const GLubyte {
        const String = struct {
    ...
    pub extern "webgl" fn uniform2i(_location: GLint, _v0: GLint, _v1: GLint) callconv(.C) void;

    pub extern "webgl" fn hint(_target: GLenum, _mode: GLenum) void;
    ...
    pub extern "webgl" fn bindRenderbuffer(_target: GLenum, _renderbuffer: GLuint) void;
    pub extern "webgl" fn blendColor(_red: GLfloat, _green: GLfloat, _blue: GLfloat, _alpha: GLfloat) void;
    pub extern "webgl" fn blendEquationSeparate(_modeRGB: GLenum, _modeAlpha: GLenum) void;
    pub extern "webgl" fn blendFuncSeparate(_sfactorRGB: GLenum, _dfactorRGB: GLenum, _sfactorAlpha: GLenum, _dfactorAlpha: GLenum) void;
    pub extern "webgl" fn bufferSubData(_target: GLenum, _offset: GLintptr, _size: GLsizeiptr, _data: ?*const anyopaque) void;
    pub extern "webgl" fn clearDepthf(_d: GLfloat) void;
    pub extern "webgl" fn clearStencil(_s: GLint) void;
    pub extern "webgl" fn colorMask(_red: GLboolean, _green: GLboolean, _blue: GLboolean, _alpha: GLboolean) void;
    pub extern "webgl" fn compressedTexImage2D(_target: GLenum, _level: GLint, _internalformat: GLenum, _width: GLsizei, _height: GLsizei, _border: GLint, _imageSize: GLsizei, _data: ?*const anyopaque) void;
    pub extern "webgl" fn compressedTexSubImage2D(_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _width: GLsizei, _height: GLsizei, _format: GLenum, _imageSize: GLsizei, _data: ?*const anyopaque) void;
    pub extern "webgl" fn copyTexImage2D(_target: GLenum, _level: GLint, _internalformat: GLenum, _x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei, _border: GLint) void;
    pub extern "webgl" fn copyTexSubImage2D(_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei) void;
    pub extern "webgl" fn deleteFramebuffers(_n: GLsizei, _framebuffers: [*c]const GLuint) void;
    pub extern "webgl" fn deleteRenderbuffers(_n: GLsizei, _renderbuffers: [*c]const GLuint) void;
    pub extern "webgl" fn deleteTextures(_n: GLsizei, _textures: [*c]const GLuint) void;
    pub extern "webgl" fn depthMask(_flag: GLboolean) void;
    pub extern "webgl" fn depthRangef(_n: GLfloat, _f: GLfloat) void;
    pub extern "webgl" fn disableVertexAttribArray(_index: GLuint) void;
    pub extern "webgl" fn finish() void;
    pub extern "webgl" fn flush() void;
    pub extern "webgl" fn framebufferRenderbuffer(_target: GLenum, _attachment: GLenum, _renderbuffertarget: GLenum, _renderbuffer: GLuint) void;
    pub extern "webgl" fn generateMipmap(_target: GLenum) void;
    pub extern "webgl" fn genFramebuffers(_n: GLsizei, _framebuffers: [*c]GLuint) void;
    pub extern "webgl" fn genRenderbuffers(_n: GLsizei, _renderbuffers: [*c]GLuint) void;
    pub extern "webgl" fn getActiveAttrib(_program: GLuint, _index: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _size: [*c]GLint, _type: [*c]GLenum, _name: [*c]GLchar) void;
    pub extern "webgl" fn getActiveUniform(_program: GLuint, _index: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _size: [*c]GLint, _type: [*c]GLenum, _name: [*c]GLchar) void;
    pub extern "webgl" fn getAttachedShaders(_program: GLuint, _maxCount: GLsizei, _count: [*c]GLsizei, _shaders: [*c]GLuint) void;
    pub extern "webgl" fn getBooleanv(_pname: GLenum, _data: [*c]GLboolean) void;
    pub extern "webgl" fn getBufferParameteriv(_target: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    pub extern "webgl" fn getFloatv(_pname: GLenum, _data: [*c]GLfloat) void;
    pub extern "webgl" fn getFramebufferAttachmentParameteriv(_target: GLenum, _attachment: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    pub extern "webgl" fn getIntegerv(_pname: GLenum, _data: [*c]GLint) void;
    pub extern "webgl" fn getRenderbufferParameteriv(_target: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    pub extern "webgl" fn getShaderPrecisionFormat(_shadertype: GLenum, _precisiontype: GLenum, _range: [*c]GLint, _precision: [*c]GLint) void;
    pub extern "webgl" fn getShaderSource(_shader: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _source: [*c]GLchar) void;
    pub extern "webgl" fn getTexParameterfv(_target: GLenum, _pname: GLenum, _params: [*c]GLfloat) void;
    pub extern "webgl" fn getTexParameteriv(_target: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    pub extern "webgl" fn getUniformfv(_program: GLuint, _location: GLint, _params: [*c]GLfloat) void;
    pub extern "webgl" fn getUniformiv(_program: GLuint, _location: GLint, _params: [*c]GLint) void;
    pub extern "webgl" fn getVertexAttribfv(_index: GLuint, _pname: GLenum, _params: [*c]GLfloat) void;
    pub extern "webgl" fn getVertexAttribiv(_index: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    pub extern "webgl" fn getVertexAttribPointerv(_index: GLuint, _pname: GLenum, _pointer: ?*?*anyopaque) void;
    pub extern "webgl" fn isBuffer(_buffer: GLuint) GLboolean;
    pub extern "webgl" fn isEnabled(_cap: GLenum) GLboolean;
    pub extern "webgl" fn isFramebuffer(_framebuffer: GLuint) GLboolean;
    pub extern "webgl" fn isProgram(_program: GLuint) GLboolean;
    pub extern "webgl" fn isRenderbuffer(_renderbuffer: GLuint) GLboolean;
    pub extern "webgl" fn isShader(_shader: GLuint) GLboolean;
    pub extern "webgl" fn isTexture(_texture: GLuint) GLboolean;
    pub extern "webgl" fn lineWidth(_width: GLfloat) void;
    pub extern "webgl" fn polygonOffset(_factor: GLfloat, _units: GLfloat) void;
    pub extern "webgl" fn readPixels(_x: GLint, _y: GLint, _width: GLsizei, _height: GLsizei, _format: GLenum, _type: GLenum, _pixels: ?*anyopaque) void;
    pub extern "webgl" fn releaseShaderCompiler() void;
    pub extern "webgl" fn renderbufferStorage(_target: GLenum, _internalformat: GLenum, _width: GLsizei, _height: GLsizei) void;
    pub extern "webgl" fn sampleCoverage(_value: GLfloat, _invert: GLboolean) void;
    pub extern "webgl" fn shaderBinary(_count: GLsizei, _shaders: [*c]const GLuint, _binaryFormat: GLenum, _binary: ?*const anyopaque, _length: GLsizei) void;
    pub extern "webgl" fn stencilFunc(_func: GLenum, _ref: GLint, _mask: GLuint) void;
    pub extern "webgl" fn stencilFuncSeparate(_face: GLenum, _func: GLenum, _ref: GLint, _mask: GLuint) void;
    pub extern "webgl" fn stencilMask(_mask: GLuint) void;
    pub extern "webgl" fn stencilMaskSeparate(_face: GLenum, _mask: GLuint) void;
    pub extern "webgl" fn stencilOp(_fail: GLenum, _zfail: GLenum, _zpass: GLenum) void;
    pub extern "webgl" fn stencilOpSeparate(_face: GLenum, _sfail: GLenum, _dpfail: GLenum, _dppass: GLenum) void;
    pub extern "webgl" fn texParameterfv(_target: GLenum, _pname: GLenum, _params: [*c]const GLfloat) void;
    pub extern "webgl" fn texParameteriv(_target: GLenum, _pname: GLenum, _params: [*c]const GLint) void;
    pub extern "webgl" fn texSubImage2D(_target: GLenum, _level: GLint, _xoffset: GLint, _yoffset: GLint, _width: GLsizei, _height: GLsizei, _format: GLenum, _type: GLenum, _pixels: ?*const anyopaque) void;
    pub extern "webgl" fn uniform1fv(_location: GLint, _count: GLsizei, _value: [*c]const GLfloat) void;
    pub extern "webgl" fn uniform1iv(_location: GLint, _count: GLsizei, _value: [*c]const GLint) void;
    pub extern "webgl" fn uniform2f(_location: GLint, _v0: GLfloat, _v1: GLfloat) void;
    pub extern "webgl" fn uniform2fv(_location: GLint, _count: GLsizei, _value: [*c]const GLfloat) void;
    pub extern "webgl" fn uniform2iv(_location: GLint, _count: GLsizei, _value: [*c]const GLint) void;
    pub extern "webgl" fn uniform3f(_location: GLint, _v0: GLfloat, _v1: GLfloat, _v2: GLfloat) void;
    pub extern "webgl" fn uniform3fv(_location: GLint, _count: GLsizei, _value: [*c]const GLfloat) void;
    pub extern "webgl" fn uniform3i(_location: GLint, _v0: GLint, _v1: GLint, _v2: GLint) void;
    pub extern "webgl" fn uniform3iv(_location: GLint, _count: GLsizei, _value: [*c]const GLint) void;
    pub extern "webgl" fn uniform4fv(_location: GLint, _count: GLsizei, _value: [*c]const GLfloat) void;
    pub extern "webgl" fn uniform4i(_location: GLint, _v0: GLint, _v1: GLint, _v2: GLint, _v3: GLint) void;
    pub extern "webgl" fn uniform4iv(_location: GLint, _count: GLsizei, _value: [*c]const GLint) void;
    pub extern "webgl" fn uniformMatrix2fv(_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    pub extern "webgl" fn uniformMatrix3fv(_location: GLint, _count: GLsizei, _transpose: GLboolean, _value: [*c]const GLfloat) void;
    pub extern "webgl" fn validateProgram(_program: GLuint) void;
    pub extern "webgl" fn vertexAttrib1f(_index: GLuint, _x: GLfloat) void;
    pub extern "webgl" fn vertexAttrib1fv(_index: GLuint, _v: [*c]const GLfloat) void;
    pub extern "webgl" fn vertexAttrib2f(_index: GLuint, _x: GLfloat, _y: GLfloat) void;
    pub extern "webgl" fn vertexAttrib2fv(_index: GLuint, _v: [*c]const GLfloat) void;
    pub extern "webgl" fn vertexAttrib3f(_index: GLuint, _x: GLfloat, _y: GLfloat, _z: GLfloat) void;
    pub extern "webgl" fn vertexAttrib3fv(_index: GLuint, _v: [*c]const GLfloat) void;
    pub extern "webgl" fn vertexAttrib4f(_index: GLuint, _x: GLfloat, _y: GLfloat, _z: GLfloat, _w: GLfloat) void;
    pub extern "webgl" fn vertexAttrib4fv(_index: GLuint, _v: [*c]const GLfloat) void;
};

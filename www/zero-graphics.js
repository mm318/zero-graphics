...
function createInputModule(canvas_element, getInstance, stop_fn) {
    ...
    canvas_element.addEventListener('mousedown', (ev) => {
        ...
        if (inst !== undefined) {
            inst.exports.app_input_sendMouseDown(ev.clientX * window.devicePixelRatio, ev.clientY * window
                .devicePixelRatio, ev.button)
        }
    })
    ...
    canvas_element.addEventListener('mouseup', (ev) => {
        ...
        let inst = getInstance()
        if (inst !== undefined) {
            inst.exports.app_input_sendMouseUp(ev.clientX * window.devicePixelRatio, ev.clientY * window
                .devicePixelRatio, ev.button)
        }
    })
    ...
    canvas_element.addEventListener('mousemove', (ev) => {
        let inst = getInstance()
        if (inst !== undefined) {
            inst.exports.app_input_sendMouseMotion(ev.clientX * window.devicePixelRatio, ev.clientY * window
                .devicePixelRatio)
        }
    })
